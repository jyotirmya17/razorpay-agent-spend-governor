...
- **Hard-Negative Denominators**:
  ...
  - LEGITIMATE_TEMPORARY_SPIKE: total = 62, flagged = 32, FPR = 32/62 (51.61%)
...
- **LEGITIMATE_TEMPORARY_SPIKE**: FPR = 51.61% (32/62)
- **LEGITIMATE_CATEGORY_CHANGE**: FPR = 31.82% (7/22)
- **LEGITIMATE_LARGE_INVOICE**: FPR = 78.95% (15/19)

## Part B: Adversarial Scenarios
- **A. PAYEE + AMOUNT EVASION** -> Score: 0.653 | Detected: True | Decision: FLAG (VALID_REQUEST, BEHAVIOR_REVIEW_REQUIRED)
- **B. AMOUNT + TIME EVASION** -> Score: 0.546 | Detected: True | Decision: FLAG (VALID_REQUEST, BEHAVIOR_REVIEW_REQUIRED)
- **C. CATEGORY + PAYEE EVASION** -> Score: 0.538 | Detected: True | Decision: FLAG (VALID_REQUEST, BEHAVIOR_REVIEW_REQUIRED)
- **D. VELOCITY ATTACK** -> Score: 0.609 | Detected: True | Decision: FLAG (VALID_REQUEST, BEHAVIOR_REVIEW_REQUIRED)
- **F. MULTI-SIGNAL ATTACK** -> Score: 0.573 | Detected: True | Decision: FLAG (VALID_REQUEST, BEHAVIOR_REVIEW_REQUIRED)

## Part C: Unseen Agent Analysis
- Known Agent FPR: 8.59%
- Overall Unseen Agent FPR: 29.09%
  ...
  - History [50-999998] txns -> FPR: 18.23% (97/532)
...
- **Threshold 0.35**: F1=0.108 | Cost=15850
- **Threshold 0.40**: F1=0.194 | Cost=8360
- **Threshold 0.42**: F1=0.214 | Cost=7970
- **Threshold 0.45**: F1=0.197 | Cost=8550
- **Threshold 0.50**: F1=0.158 | Cost=9080
